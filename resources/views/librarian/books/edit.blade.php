<x-layouts.app>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Edit Buku') }}</h1>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="publish_year" name="publish_year"
                            value="{{ old('publish_year', $book->publish_year) }}" min="1800"
                            max="{{ date('Y') }}"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">{{ __('Tersedia saat ini:') }}
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all">{{ old('description', $book->description) }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if ($book->pdf_file)
                            <div class="mb-3 flex items-center gap-2 text-sm text-green-600 dark:text-green-400">
                                ...
                                <span>{{ __('PDF sudah diupload') }}</span>
                                <a href="{{ route('book.read', $book) }}" target="_blank"
                                    class="text-indigo-600 dark:text-indigo-400 hover:underline">{{ __('Lihat') }}</a>
                            </div>
                        @endif
