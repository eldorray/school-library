        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-auto bg-gray-100 dark:bg-gray-900 content-transition">
                <div class="p-6">
                    ...
                    <!-- Validation Errors -->
                    @if ($errors->any())
                        <div x-data="{ showValidationErrors: true }" x-show="showValidationErrors"
                            x-transition:enter="transition ease-out duration-300"
                            x-transition:enter-start="opacity-0 transform -translate-y-2"
                            x-transition:enter-end="opacity-100 transform translate-y-0"
                            x-transition:leave="transition ease-in duration-300"
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3 flex-1">
                                    <h3 class="text-sm font-medium text-red-700 dark:text-red-200">
                                        {{ __('Terdapat kesalahan pada input Anda:') }}
                                    </h3>
                                    <ul
                                        class="mt-2 text-sm text-red-600 dark:text-red-300 list-disc list-inside space-y-1">
                                ...
                                <div class="ml-auto pl-3">
                                    <div class="-mx-1.5 -my-1.5">
                                        <button @click="showValidationErrors = false"
                                            class="inline-flex rounded-md p-1.5 text-red-500 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                            <span class="sr-only">{{ __('Tutup') }}</span>
